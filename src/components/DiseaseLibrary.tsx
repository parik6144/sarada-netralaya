...
const diseases: Disease[] = [
  ...
  },
  {
    ...
    riskFactors: ['Age above 50', 'Being female (hormonal changes)', 'Prolonged computer/screen use', 'Wearing contact lenses', 'Dry environment (AC, low humidity)', 'Refractive surgery history', 'Autoimmune conditions'],
