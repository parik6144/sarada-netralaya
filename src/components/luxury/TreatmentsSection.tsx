...
const treatments = [
  ...
  },
  {
    ...
    slug: 'refractive',
    tag: 'ICL · IPCL · CLEAR VISION',
    line: 'Implantable lens options for clearer vision when glasses are not enough.',
  ...
  },
  {
    ...
    slug: 'pediatric',
    tag: 'GROWING EYES',
    line: 'Amblyopia, squint, glasses & school vision screening — gentle care while vision is still developing.',
