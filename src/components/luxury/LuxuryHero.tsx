...
export default function LuxuryHero() {
  ...
  return (
    ...
    >
      ...
      <div className="nav-offset-hero relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-6 pb-16 lg:pb-20">
        <div
          ref={contentRef}
        ...
        >
          ...
          <p className="mt-2 text-[11px] sm:text-xs tracking-[0.16em] uppercase text-slate-500 font-semibold">
            Advanced Eye Care Center · Baradwari, Sakchi, Jamshedpur
          </p>

          <h1 className="mt-4 text-[1.9rem] sm:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.12] text-[#0B1F3A]">
            <span className="block">Restoring Vision.</span>
            <span className="block text-brand-red mt-1">Transforming Lives.</span>
          </h1>

          <p className="mt-5 text-sm sm:text-base text-slate-600 max-w-lg mx-auto lg:mx-0 leading-relaxed">
