...
export const doctors: DoctorProfile[] = [
  {
    ...
    education:
      'Undergraduate medical education — B. J. Medical College and Sassoon General Hospital, Pune, Maharashtra. Postgraduate training in Ophthalmology — L. V. Prasad Eye Institute, Hyderabad. DO, DNB.',
    approach:
  ...
  },
  {
    ...
    title: 'Consultant Ophthalmologist | Cornea, Cataract & Refractive Surgeon',
    speciality: 'Cornea, Cataract & Refractive Surgeon',
    ...
    highlights: [
      'Consultant Ophthalmologist — Cornea, Cataract & Refractive',
