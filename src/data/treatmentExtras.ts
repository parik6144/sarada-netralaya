...
export const treatmentExtras: Record<string, TreatmentExtras> = {
  ...
  refractive: {
    headline: 'Refractive Surgery — ICL & IPCL Options',
    promise: 'EVALUATE · COUNSEL · CORRECT',
    simpleWhat:
      'If your eye power is high or glasses are hard to live with, an implantable lens inside the eye can help light focus more clearly — without removing your natural lens.',
    simpleFeel:
      'You depend on thick glasses or contacts for school, work, or sports — and want a carefully planned refractive solution.',
    simpleFix:
      'After detailed tests, we counsel you on ICL and IPCL suitability and plan the safest option for your eyes and lifestyle.',
    highlights: [
      'Special focus on ICL and IPCL implantable lenses',
      'Full suitability tests before any recommendation',
      'Honest counselling — only if your eyes are right for it',
      'Personalised plan for clearer everyday vision',
    ],
    features: [
    ...
    lifestyleCaption: 'Clearer everyday vision with implantable lens options',
    metaphorTitle: 'Think of adding a precise focusing lens inside the camera',
    metaphorBody:
      'Glasses sit outside the eye. ICL/IPCL sit inside, fine-tuning focus while your natural lens stays in place — when measurements show you are a good candidate.',
    storySteps: [
      { title: 'Full refractive workup', body: 'We measure power, cornea, chamber depth, and overall eye health.' },
      { title: 'ICL / IPCL counselling', body: 'We explain which implantable option may suit you — or when it may not.' },
      { title: 'Personalised plan', body: 'Lens choice and safety checks are matched to your lifestyle needs.' },
      { title: 'Follow-up care', body: 'Drops, reviews, and vision goals are explained clearly before and after.' },
    ],
    compareGood: {
      label: 'Goal',
      title: 'Clearer — freer from thick spectacles',
    ...
    whoShould: [
      { title: 'High power', body: 'Thick glasses or contact intolerance.' },
      { title: 'Active lifestyle', body: 'Sports or work where glasses get in the way.' },
      { title: 'Stable prescription', body: 'Power that has been reasonably stable.' },
      { title: 'Want counselling first', body: 'You want clear answers before deciding.' },
    ],
    hubBlurb: 'Refractive counselling with ICL & IPCL — full workup, honest suitability advice.',
    whenToSee: 'High power, contact intolerance, or interest in implantable lens options.',
  },
  retina: {
  ...
  pediatric: {
    ...
    lifestyleCaption: 'Amblyopia, squint, glasses & school vision screening — gentle care while vision is still developing',
    ...
    hubBlurb: 'Amblyopia, squint, glasses & school vision screening — gentle care while vision is still developing.',
